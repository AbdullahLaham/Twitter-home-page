const textareaNewTweet = document.querySelector('.bowl-area-text')
const typePeople = document.querySelector('.type-tweet-view')
const addTweet = document.querySelector('.btn-puplish-tweet')
